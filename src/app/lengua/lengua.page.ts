...
@Component({
  selector: 'app-lengua',
  templateUrl: './lengua.page.html',
  styleUrls: ['./lengua.page.scss'],
})
export class LenguaPage implements OnInit {
  ...
  constructor() {
    // Cambiamos la llamada al método
  ...
  private generarAsistenciasFijas() {
    ...
    const diasFalta = [9, 7, 8, 29]; // Ejemplo: faltó los días 2, 8, 15, 22 y 29 del mes
